...
(async()=>{
  ...
  console.log('PASS 5,571 cities and 27 capitals: geographic IDs, homonyms, bounded search, four UTC offsets, nearest city, INMET isolation, saved favorites and stale-request isolation.');
