...
assert.match(sw, /pluvia-core-69/);
...
assert.match(html, /modules\/weather-services\.js\?v=core-69/);
assert.match(html, /modules\/weather-insights\.js\?v=core-64/);
assert.match(html, /app\.js\?v=core-69/);
assert.match(html, /modules\/radar-probe\.js\?v=core-68/);
