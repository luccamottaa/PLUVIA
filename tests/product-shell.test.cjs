...
assert.match(sw, /pluvia-core-107/);
...
assert.match(sw, /weather-map\.js\?v=core-107/);
...
assert.match(html, /modules\/weather-data-layer\.js\?v=core-107/);
assert.match(html, /modules\/met-merge\.js\?v=core-107/);
assert.match(sw, /modules\/met-merge\.js\?v=core-107/);
assert.match(html, /modules\/http-client\.js\?v=core-67/);
assert.match(html, /modules\/weather-services\.js\?v=core-107/);
