...
assert.match(html, /MAPA DO TEMPO[\s\S]*Radar observado, imagens de satélite e nuvens estimadas\./i);
...
assert.match(sw, /pluvia-core-98/);
...
assert.match(sw, /weather-map\.js\?v=core-98/);
...
assert.match(html, /modules\/weather-data-layer\.js\?v=core-98/);
assert.match(html, /modules\/http-client\.js\?v=core-67/);
assert.match(html, /modules\/weather-services\.js\?v=core-98/);
