...
assert.match(sw, /pluvia-core-99/);
...
assert.match(sw, /weather-map\.js\?v=core-99/);
...
assert.match(html, /modules\/weather-data-layer\.js\?v=core-99/);
assert.match(html, /modules\/http-client\.js\?v=core-67/);
assert.match(html, /modules\/weather-services\.js\?v=core-99/);
