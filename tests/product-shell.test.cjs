...
assert.match(html, /class="footer-details"[\s\S]*Alertas meteorológicos: INMET/);
...
assert.match(sw, /pluvia-core-108/);
...
assert.match(sw, /weather-map\.js\?v=core-108/);
...
assert.match(html, /modules\/weather-data-layer\.js\?v=core-108/);
assert.match(html, /modules\/met-merge\.js\?v=core-108/);
assert.match(sw, /modules\/met-merge\.js\?v=core-108/);
assert.match(html, /modules\/http-client\.js\?v=core-67/);
assert.match(html, /modules\/weather-services\.js\?v=core-108/);
