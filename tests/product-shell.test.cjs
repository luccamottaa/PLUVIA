...
assert.match(html, /id="skipIntro"[^>]*>Pular<\/button>/);
assert.match(html, /class="intro-logo"[\s\S]*?src="\.\/assets\/pluvia-footer-logo\.jpeg"/);
assert.match(html, /class="intro-progress"/);
assert.match(p0, /setTimeout\(dismissIntro, introDuration\)/);
assert.match(p0, /prefers-reduced-motion: reduce/);
...
assert.match(html, /class="footer-brand"[\s\S]*?src="\.\/assets\/pluvia-footer-logo\.jpeg"[^>]*alt="PLUVIA — O céu de cada cidade"/);
assert.doesNotMatch(html, /<p>PLUVIA · O céu de cada cidade\.<\/p>/);
assert.ok(fs.statSync(path.join(root, 'dist/assets/pluvia-footer-logo.jpeg')).size > 10000);
assert.match(sw, /assets\/pluvia-footer-logo\.jpeg/);
...
assert.match(sw, /pluvia-core-88/);
...
assert.match(sw, /weather-map\.js\?v=core-88/);
...
assert.match(html, /modules\/weather-data-layer\.js\?v=core-88/);
assert.match(html, /modules\/http-client\.js\?v=core-67/);
assert.match(html, /modules\/weather-services\.js\?v=core-88/);
