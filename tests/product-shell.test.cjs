...
assert.match(sw, /pluvia-core-63/);
...
assert.match(html, /modules\/weather-data-layer\.js\?v=core-63/);
assert.match(html, /modules\/weather-insights\.js\?v=core-63/);
