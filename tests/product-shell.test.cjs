...
assert.match(html, /id="weatherMap"[^>]*>[\s\S]*?id="weatherPlay"[\s\S]*?<\/article>\s*<\/section>\s*<div id="riskAnchor"/);
...
assert.match(sw, /pluvia-core-114/);
...
assert.match(html, /id="weatherMap"/);
...
assert.match(sw, /weather-map\.js\?v=core-114/);
