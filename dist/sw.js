const CACHE = "pluvia-core-109";
const SHELL = "./index.html";
self.addEventListener("install", event => {
  event.waitUntil(caches.open(CACHE).then(cache => cache.addAll([
    "./", SHELL, "./analytics.js?v=analytics-3", "./styles.css?v=core-109", "./capitals.js?v=core-47", "./app.js?v=core-109", "./p0.js?v=core-109", "./account.js?v=core-109", "./saved-places.js?v=core-109", "./notifications.js?v=core-109", "./weather-map.js?v=core-109",
    ...
    "./manifest.webmanifest", "./logo-mark.png", "./logo-pluvia.png", "./favicon-32.png", "./apple-touch-icon-180.png", "./icon-192.png", "./icon-512.png", "./icon-splash-192.png", "./icon-splash-512.png", "./icon-maskable-192.png", "./icon-maskable-512.png",
