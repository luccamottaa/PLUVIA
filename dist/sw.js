const CACHE = "pluvia-core-75";
const SHELL = "./index.html";
self.addEventListener("install", event => {
  event.waitUntil(caches.open(CACHE).then(cache => cache.addAll([
    "./", SHELL, "./analytics.js?v=analytics-3", "./styles.css?v=core-75", "./capitals.js?v=core-47", "./app.js?v=core-74", "./p0.js?v=core-60", "./account.js?v=core-58", "./saved-places.js?v=core-60", "./notifications.js?v=push-4", "./weather-map.js?v=core-68",
