const CACHE = "pluvia-core-70";
const SHELL = "./index.html";
self.addEventListener("install", event => {
  event.waitUntil(caches.open(CACHE).then(cache => cache.addAll([
    "./", SHELL, "./analytics.js?v=analytics-2", "./styles.css?v=core-70", "./capitals.js?v=core-47", "./app.js?v=core-70", "./p0.js?v=core-60", "./account.js?v=core-58", "./saved-places.js?v=core-60", "./notifications.js?v=push-4", "./weather-map.js?v=core-68",
