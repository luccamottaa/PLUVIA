...
self.addEventListener("install", event => {
  event.waitUntil(caches.open(CACHE).then(cache => cache.addAll([
    "./", SHELL, "./analytics.js?v=analytics-2", "./styles.css?v=core-53", "./capitals.js?v=core-47", "./app.js?v=core-53", "./p0.js?v=core-47", "./account.js?v=core-48", "./notifications.js?v=push-2", "./weather-map.js?v=core-47",
    "./modules/sources.js?v=core-47", "./modules/signal.js?v=core-47", "./modules/smart-summary.js?v=core-49", "./modules/weather-icons.js?v=core-49", "./modules/weather-icon-system.js?v=glossy-1", "./modules/risks.js?v=core-47", "./modules/adapters.js?v=core-47",
    "./manifest.webmanifest", "./logo-mark.png", "./logo-pluvia.png", "./icon-192.png", "./icon-512.png", "./icon-maskable-512.png",
