const CACHE = "pluvia-core-59";
const SHELL = "./index.html";
self.addEventListener("install", event => {
  event.waitUntil(caches.open(CACHE).then(cache => cache.addAll([
    "./", SHELL, "./analytics.js?v=analytics-2", "./styles.css?v=core-59", "./capitals.js?v=core-47", "./app.js?v=core-56", "./p0.js?v=core-47", "./account.js?v=core-58", "./saved-places.js?v=core-59", "./notifications.js?v=push-2", "./weather-map.js?v=core-47",
