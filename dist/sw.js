...
self.addEventListener("install", event => {
  event.waitUntil(caches.open(CACHE).then(cache => cache.addAll([
    ...
    "./modules/sources.js?v=core-47", "./modules/weather-data-layer.js?v=core-55", "./modules/signal.js?v=core-47", "./modules/smart-summary.js?v=core-49", "./modules/weather-icons.js?v=core-49", "./modules/weather-icon-system.js?v=glossy-1", "./modules/risks.js?v=core-47", "./modules/adapters.js?v=core-47",
