const CACHE = "pluvia-core-88";
const SHELL = "./index.html";
self.addEventListener("install", event => {
  event.waitUntil(caches.open(CACHE).then(cache => cache.addAll([
    "./", SHELL, "./analytics.js?v=analytics-3", "./styles.css?v=core-88", "./capitals.js?v=core-47", "./app.js?v=core-88", "./p0.js?v=core-88", "./account.js?v=core-88", "./saved-places.js?v=core-88", "./notifications.js?v=core-88", "./weather-map.js?v=core-88",
    "./modules/sources.js?v=core-71", "./modules/http-client.js?v=core-67", "./modules/weather-services.js?v=core-88", "./modules/weather-data-layer.js?v=core-88", "./modules/weather-insights.js?v=core-64", "./modules/radar-probe.js?v=core-70", "./modules/smart-summary.js?v=core-88", "./modules/weather-icons.js?v=core-49", "./modules/weather-icon-system.js?v=glossy-2", "./modules/risks.js?v=core-71", "./modules/adapters.js?v=core-71", "./vendor/suncalc.js?v=core-88", "./vendor/suncalc-LICENSE",
    "./manifest.webmanifest", "./logo-mark.png", "./logo-pluvia.png", "./assets/pluvia-footer-logo.jpeg", "./favicon-32.png", "./apple-touch-icon-180.png", "./icon-192.png", "./icon-512.png", "./icon-maskable-192.png", "./icon-maskable-512.png",
