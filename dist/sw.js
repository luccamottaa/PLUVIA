const CACHE = "pluvia-core-107";
const SHELL = "./index.html";
self.addEventListener("install", event => {
  event.waitUntil(caches.open(CACHE).then(cache => cache.addAll([
    "./", SHELL, "./analytics.js?v=analytics-3", "./styles.css?v=core-107", "./capitals.js?v=core-47", "./app.js?v=core-107", "./p0.js?v=core-107", "./account.js?v=core-107", "./saved-places.js?v=core-107", "./notifications.js?v=core-107", "./weather-map.js?v=core-107",
    "./modules/sources.js?v=core-107", "./modules/http-client.js?v=core-67", "./modules/weather-services.js?v=core-107", "./modules/weather-data-layer.js?v=core-107", "./modules/met-merge.js?v=core-107", "./modules/weather-extras.js?v=core-107", "./modules/weather-insights.js?v=core-64", "./modules/radar-probe.js?v=core-70", "./modules/smart-summary.js?v=core-107", "./modules/weather-icons.js?v=core-49", "./modules/weather-icon-system.js?v=vector-4", "./modules/risks.js?v=core-71", "./modules/adapters.js?v=core-107", "./vendor/suncalc.js?v=core-107", "./vendor/suncalc-LICENSE",
    ...
    "./assets/weather-icons/conditions/clear-day.svg", "./assets/weather-icons/conditions/clear-night.svg", "./assets/weather-icons/conditions/partly-cloudy-day.svg", "./assets/weather-icons/conditions/partly-cloudy-night.svg?v=moon-2", "./assets/weather-icons/conditions/cloudy.svg", "./assets/weather-icons/conditions/overcast.svg", "./assets/weather-icons/conditions/fog.svg", "./assets/weather-icons/conditions/haze.svg", "./assets/weather-icons/conditions/light-rain.svg", "./assets/weather-icons/conditions/moderate-rain.svg", "./assets/weather-icons/conditions/heavy-rain.svg", "./assets/weather-icons/conditions/showers.svg", "./assets/weather-icons/conditions/showers-night.svg?v=moon-2", "./assets/weather-icons/conditions/thunderstorm.svg", "./assets/weather-icons/conditions/thunderstorm-rain.svg", "./assets/weather-icons/conditions/thunderstorm-hail.svg", "./assets/weather-icons/conditions/snow.svg",
    "./assets/weather-icons/metrics/temperature.png", "./assets/weather-icons/metrics/feels-like-pluvia.svg", "./assets/weather-icons/metrics/temperature-high-pluvia.svg", "./assets/weather-icons/metrics/temperature-low-pluvia.svg", "./assets/weather-icons/metrics/humidity.png", "./assets/weather-icons/metrics/dew-point.png", "./assets/weather-icons/metrics/pressure.png", "./assets/weather-icons/metrics/visibility-pluvia.svg", "./assets/weather-icons/metrics/wind-speed.png", "./assets/weather-icons/metrics/wind-gust.png", "./assets/weather-icons/metrics/wind-direction.png", "./assets/weather-icons/metrics/cloud-cover.png", "./assets/weather-icons/metrics/uv-index.png", "./assets/weather-icons/metrics/air-quality.png", "./assets/weather-icons/metrics/rain-probability.png", "./assets/weather-icons/metrics/rain-volume.png"
  ])));
  self.skipWaiting();
});
