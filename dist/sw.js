const CACHE = "pluvia-core-67";
const SHELL = "./index.html";
self.addEventListener("install", event => {
  event.waitUntil(caches.open(CACHE).then(cache => cache.addAll([
    "./", SHELL, "./analytics.js?v=analytics-2", "./styles.css?v=core-60", "./capitals.js?v=core-47", "./app.js?v=core-67", "./p0.js?v=core-60", "./account.js?v=core-58", "./saved-places.js?v=core-60", "./notifications.js?v=push-4", "./weather-map.js?v=core-47",
    "./modules/sources.js?v=core-47", "./modules/http-client.js?v=core-67", "./modules/weather-data-layer.js?v=core-66", "./modules/weather-insights.js?v=core-64", "./modules/signal.js?v=core-60", "./modules/radar-probe.js?v=core-60", "./modules/smart-summary.js?v=core-49", "./modules/weather-icons.js?v=core-49", "./modules/weather-icon-system.js?v=glossy-2", "./modules/risks.js?v=core-47", "./modules/adapters.js?v=core-47",
