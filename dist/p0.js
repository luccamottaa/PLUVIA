...
weatherIconSvg = function (code, isDay = true) {
  ...
  const moonClear = `<g class="wx-moon"><path class="wx-moon-core" d="M62 18c-4 5-6 11-6 18 0 16 13 29 29 29 3 0 7-1 10-2-4 14-17 24-32 24-19 0-34-15-34-34 0-16 11-29 28-33 1 6-1 13-4 18 3-6 8-11 15-14z"/><circle class="wx-moon-crater" cx="48" cy="36" r="3.6"/><circle class="wx-moon-crater" cx="42" cy="50" r="2.4"/></g>`;
  const moonBehind = `<g class="wx-moon"><path class="wx-moon-core" d="M36 8c-8 4-14 13-14 23 0 15 12 27 27 27 4 0 8-1 11-3-3 2-7 3-11 3-14 0-26-11-26-25 0-10 6-19 15-23 0-1-1-1-2-2z"/><circle class="wx-moon-crater" cx="28" cy="24" r="3"/><circle class="wx-moon-crater" cx="24" cy="34" r="2"/></g>`;
